...
const int BUTTONPIN = INT0; //Pin 3
volatile int buttonState = 2; //Volatile used for interrupt (Default mode B)
const int LEDA = 5; //CHANGE THIS. LED TO DEMARCATE MODE A IS ACTIVE
const int LEDB = 6; //CHANGE THIS. LED TO DEMARCATE MODE B IS ACTIVE
const int LEDC = 7; //CHANGE THIS. LED TO DEMARCATE MODE C IS ACTIVE
...
//LCD variables
const int LCDPIN = 11; //CHANGE THIS
